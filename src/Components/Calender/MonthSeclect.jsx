...
export const MonthSeclect = ({ option, setSelectedDate, selectedDate }) => {
  // const [optionData, setOptionData] = useState(option[selectedDate.getMonth()]);
  ...
  return (
    <div className="w-auto relative text-white ">
      <div className="w-[150px] md:w-[170px]  bg-transparent  rounded-lg shadow-md shadow-gray-700  p-1 h-[30px] flex items-center justify-between border-2 border-white">
        <h1 className=" text-xl font-bold">
          {option[selectedDate.getMonth()]}
        </h1>
        <h1
